...
export function AuthProvider({ children }) {
  ...
  return <AuthContext.Provider value={authInterface}>{children}</AuthContext.Provider>;
}
...
export function withAuth(Component) {
  return function (props) {
    return <AuthContext.Consumer>{(value) => <Component {...props} auth={value} />}</AuthContext.Consumer>;
  };
}
